...
from Task_Traker import models
from django.views.generic import ListView, DetailView, CreateView, View, UpdateView, DeleteView
from django.contrib.auth.mixins import LoginRequiredMixin
from Task_Traker.mixins import UserIsOwnerMixin
from Task_Traker.forms import TaskForm, TaskFilterForm, CommentForm
...
class TaskDetailView(LoginRequiredMixin, DetailView):
    ...
    template_name = 'Task_Traker/task_detail.html'
...
class TaskDeleteView(LoginRequiredMixin, UserIsOwnerMixin, DeleteView):
    model = models.Task
    success_url = reverse_lazy("tasks:task-list")
    template_name = "Task_Traker/task_delete_confirmation.html"


class CommentUpdateView(LoginRequiredMixin, UpdateView):
    model = models.Comment
    fields = ['content']
    template_name = 'Task_Traker/edit_comment.html'
...
class CommentDeleteView(LoginRequiredMixin, DeleteView):
    model = models.Comment
    template_name = 'Task_Traker/delete_comment.html'
...
class CustomLoginView(LoginView):
    template_name = "Task_Traker/login.html"
